...
indvars=cbind("Age","Sex","Clinical_Subtype","Tremor.Akinesia_Subtype","Hoehn_._Yahr_Stage","Years_Since_Diagnosis","Side_of_Onset","Case..Yes.No.","Pre_LEDD","Pre_BIS_Total","Pre_EQ_Total","Pre_ICD.Total","Pre_QUIP.Total","Pre_CarerBIS_Total","Pre_CarerEQ_Total","LN_HaylingCatAErrors","LN_HaylingCatBErrors","LN_HaylingABErrorScore","LN_ELF_RuleViolations","LN_DelayDiscount_K","Max_HaylingABErrorScore_Change","LN_Max_HaylingABErrorScore_Change","Max_ELF_Violations_Change","LN_Max_ELF_Violations_Change","Max_DelayDiscount_K_Change","LN_Max_DelayDiscount_K_Change")

tracksint=cbind("RSTNtoHCPRSMA","LSTNtoHCPLSMA","RSTNtoHCPRIFG_Ant","RSTNtoHCPRIFG_Post")
