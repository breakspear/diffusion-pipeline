...
def main():
    ...
    seeds_path="/working/lab_michaebr/nikitasK/epilepsy/old_subjects/PE002_seeds.txt"
    AFD_path="/working/lab_michaebr/nikitasK/epilepsy/old_subjects/AFD/electrodetracking/PE002/"
    ...
    np.savetxt('PE002_cntme.txt', array)
