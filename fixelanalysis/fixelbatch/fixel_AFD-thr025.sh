...
AFD-thr025  /working/lab_michaebr/alistaiP/Park templateoutput wdiffbetgrpkmean #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
