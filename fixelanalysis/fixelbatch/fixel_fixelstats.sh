...
fixelstats  /working/lab_michaebr/alistaiP/Park AFD-thr025 templateoutput wdiffkmeanvar #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
