...
AFD2  /beegfs/scratch/tnc_scratch/kfo_pd_connectome/PD_connectome 1.5 upsample #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
