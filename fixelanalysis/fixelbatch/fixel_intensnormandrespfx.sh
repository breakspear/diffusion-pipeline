...
intensnormandrespfx  /beegfs/scratch/tnc_scratch/kfo_pd_connectome/PD_connectome AFD2 5TTcustwpreprockeep #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
