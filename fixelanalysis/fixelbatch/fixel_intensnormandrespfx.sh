...
intensnormandrespfx  /working/lab_michaebr/alistaiP/Park AFD4 Diff-wcust5tt #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
