...
tracks4cfe  /working/lab_michaebr/alistaiP/Park AFD-thr025 templateoutput #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
