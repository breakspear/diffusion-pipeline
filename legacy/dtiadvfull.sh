...
DIRECTORY=/working/lab_michaebr/alistaiP/diffusion-testing/1602/Diff/full
...
dwipreproc_mb -rpe_all rawdataPAdn.mif -export_grad_mrtrix adjencoding.b AP rawdataAPdn.mif eddycorr.mif -nthreads $cpus -verbose -force
...
#flirt -ref fa.nii  -in parc_fixsubcort_FSspace.nii -applyxfm -init FS2diff.mat -interp nearestneighbour -out rparc_fixsubcort.nii.gz
