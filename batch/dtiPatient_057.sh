...
subj=Patient_057
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_057

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_057 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
