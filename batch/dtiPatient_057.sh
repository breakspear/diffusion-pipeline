...
subj=Patient_057
subjDIRECTORY=/mnt/lustre/working/lab_michaebr/alistaiP/Park/Raw/Patient_057

cd $subjDIRECTORY

advfibertrackandcntmecon_phil Patient_057 /mnt/lustre/working/lab_michaebr/alistaiP/Park 25M DST #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
