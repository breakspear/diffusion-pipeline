...
subj=Patient_063
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_063

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_063 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
