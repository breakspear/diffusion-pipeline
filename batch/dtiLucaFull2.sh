...
subj=LucaFull2
subjDIRECTORY=/working/lab_michaebr/alistaiP/diffusion-testing/testPBS/Raw/LucaFull2

cd $subjDIRECTORY

advfulldiffsetup LucaFull2 /working/lab_michaebr/alistaiP/diffusion-testing/testPBS  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
