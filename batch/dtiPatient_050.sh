...
subj=Patient_050
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_050

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_050 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
