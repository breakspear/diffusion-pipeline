...
subj=Patient_059
subjDIRECTORY=/mnt/lustre/working/lab_michaebr/alistaiP/Park/Raw/Patient_059

cd $subjDIRECTORY

advfibertrackandcntmecon_phil Patient_059 /mnt/lustre/working/lab_michaebr/alistaiP/Park 25M DST #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
