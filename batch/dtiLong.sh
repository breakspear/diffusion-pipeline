...
subj=Long
subjDIRECTORY=/mnt/lustre/working/lab_michaebr/alistaiP/diffusion-testing/Keiran/PBS/Raw/Long

cd $subjDIRECTORY

segparcandcoregT1 Long /mnt/lustre/working/lab_michaebr/alistaiP/diffusion-testing/Keiran/PBS DST #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
