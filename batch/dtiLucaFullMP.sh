...
subj=LucaFullMP
subjDIRECTORY=/working/lab_michaebr/alistaiP/diffusion-testing/testPBS/Raw/LucaFullMP

cd $subjDIRECTORY

advfulldiffsetup LucaFullMP /working/lab_michaebr/alistaiP/diffusion-testing/testPBS  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
