...
subj=Patient_040
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_040

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_040 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
