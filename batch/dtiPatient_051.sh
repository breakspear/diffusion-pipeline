...
subj=Patient_051
subjDIRECTORY=/mnt/lustre/working/lab_michaebr/alistaiP/Park/Raw/Patient_051

cd $subjDIRECTORY

advfibertrackandcntmecon_phil Patient_051 /mnt/lustre/working/lab_michaebr/alistaiP/Park 25M DST #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
