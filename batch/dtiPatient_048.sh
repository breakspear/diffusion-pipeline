...
subj=Patient_048
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_048

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_048 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
