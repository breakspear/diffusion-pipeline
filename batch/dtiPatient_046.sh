...
subj=Patient_046
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_046

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_046 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
