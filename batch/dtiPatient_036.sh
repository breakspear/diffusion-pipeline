...
subj=Patient_036
subjDIRECTORY=/working/lab_michaebr/alistaiP/Park/Raw/Patient_036

cd $subjDIRECTORY

advfulldiffsetup_phil Patient_036 /working/lab_michaebr/alistaiP/Park  #"%%%%" will match to the string  that corresponds to your personalised batch script, or preferred pipeline
